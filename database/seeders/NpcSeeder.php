...
class NpcSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $quaint_house = Building::factory()->create([
            'name' => 'Quaint House',
            'description' => 'A small, charming house with a white picket fence.',
            'zone_id' => $living_quarters_zone->id,
        ]);

        $spacious_house = Building::factory()->create([
            'name' => 'Spacious House',
        ...
        $farmer_occupation = Occupation::factory()->create([
            'name' => 'Farmer',
        ...
        $farmhouse->npcs()->attach(
            $farmer = Npc::factory()->create([
                'first_name' => 'Gibb',
                'last_name' => 'Wyon',
                'occupation_id' => $farmer_occupation->id,
                'species' => 'human',
                'gender' => 'male',
            ])
        );
        ...
        $church->npcs()->attach(
            Npc::factory()->create([
                ...
                'last_name' => 'Haytere',
                'occupation_id' => Occupation::factory()->create([
                    'name' => 'Bishop',
        ...
        $farmhouse_zone->occupations()->attach($farmer_occupation);
